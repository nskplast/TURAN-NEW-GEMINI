...
export const PRODUCTS: Product[] = [
  ...
  // Gofrboxes 4-flap (FEFCO 0201)
  {
    id: 'box-5010',
    name: 'Gofrbox 1200x400x400 (5010)',
    name_ru: 'Гофроящик 1200x400x400 (5010)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1598524374912-6b0fae3f0363?auto=format&fit=crop&w=800&q=80',
    description: 'Large volume box. Volume: 192L.',
    description_ru: 'Ящик большого объема. Объем: 192л.',
    price: undefined,
    specs: { 'Dimensions': '1200x400x400mm', 'Code': '5010', 'Volume': '192L' },
    specs_ru: { 'Размеры': '1200x400x400мм', 'Артикул': '5010', 'Объем': '192л' },
    inStock: true
  },
  {
    id: 'box-970',
    name: 'Gofrbox 800x400x500 (970)',
    name_ru: 'Гофроящик 800x400x500 (970)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1598524374912-6b0fae3f0363?auto=format&fit=crop&w=800&q=80',
    ...
    price: 112.00,
    specs: { 'Dimensions': '800x400x500mm', 'Code': '970', 'Volume': '160L', 'Area': '2.21 m2' },
    specs_ru: { 'Размеры': '800x400x500мм', 'Артикул': '970', 'Объем': '160л', 'Площадь': '2.21 м2' },
    inStock: true
  },
  {
    id: 'box-790',
    name: 'Gofrbox 790x390x150',
    name_ru: 'Гофроящик 790x390x150',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    description: 'Flat box. Volume: 46.2L.',
    description_ru: 'Плоский ящик. Объем: 46.2л.',
    price: undefined,
    specs: { 'Dimensions': '790x390x150mm', 'Volume': '46.2L' },
    specs_ru: { 'Размеры': '790x390x150мм', 'Объем': '46.2л' },
    inStock: true
  },
  {
    id: 'box-751',
    name: 'Gofrbox 750x360x430 (751)',
    name_ru: 'Гофроящик 750x360x430 (751)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    ...
    price: 92.00,
    specs: { 'Dimensions': '750x360x430mm', 'Code': '751', 'Volume': '116.1L', 'Area': '1.806 m2' },
    specs_ru: { 'Размеры': '750x360x430мм', 'Артикул': '751', 'Объем': '116.1л', 'Площадь': '1.806 м2' },
    inStock: true
  },
  {
    id: 'box-680',
    name: 'Gofrbox 680x390x330',
    name_ru: 'Гофроящик 680x390x330',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 87.5L.',
    description_ru: 'Объем: 87.5л.',
    price: undefined,
    specs: { 'Dimensions': '680x390x330mm', 'Volume': '87.5L' },
    specs_ru: { 'Размеры': '680x390x330мм', 'Объем': '87.5л' },
    inStock: true
  },
  {
    id: 'box-18',
    name: 'Gofrbox 630x320x340 (18)',
    name_ru: 'Гофроящик 630x320x340 (18)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1598524374912-6b0fae3f0363?auto=format&fit=crop&w=800&q=80',
    ...
    price: 66.00,
    specs: { 'Dimensions': '630x320x340mm', 'Code': '18', 'Volume': '68.5L', 'Area': '1.298 m2' },
    specs_ru: { 'Размеры': '630x320x340мм', 'Артикул': '18', 'Объем': '68.5л', 'Площадь': '1.298 м2' },
    inStock: true
  },
  {
    id: 'box-18-t22',
    name: 'Gofrbox 630x320x340 (18 T-22)',
    name_ru: 'Гофроящик 630x320x340 (18 T-22)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    ...
    price: 58.00,
    specs: { 'Dimensions': '630x320x340mm', 'Code': '18 T-22', 'Volume': '68.5L', 'Area': '1.298 m2' },
    specs_ru: { 'Размеры': '630x320x340мм', 'Артикул': '18 Т-22', 'Объем': '68.5л', 'Площадь': '1.298 м2' },
    inStock: true
  },
  {
    id: 'box-670',
    name: 'Gofrbox 600x400x400 (670)',
    name_ru: 'Гофроящик 600x400x400 (670)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1598524374912-6b0fae3f0363?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 96L. Area: 1.651 m2.',
    description_ru: 'Объем: 96л. Площадь: 1.651 м2.',
    price: 85.00,
    specs: { 'Dimensions': '600x400x400mm', 'Code': '670', 'Volume': '96L', 'Area': '1.651 m2' },
    specs_ru: { 'Размеры': '600x400x400мм', 'Артикул': '670', 'Объем': '96л', 'Площадь': '1.651 м2' },
    inStock: true
  },
  {
    id: 'box-670-t22',
    name: 'Gofrbox 600x400x400 (670 T-22)',
    name_ru: 'Гофроящик 600x400x400 (670 T-22)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 96L. Economy grade T-22.',
    description_ru: 'Объем: 96л. Эконом марка Т-22.',
    price: 77.20,
    specs: { 'Dimensions': '600x400x400mm', 'Code': '670 T-22', 'Volume': '96L', 'Area': '1.651 m2' },
    specs_ru: { 'Размеры': '600x400x400мм', 'Артикул': '670 Т-22', 'Объем': '96л', 'Площадь': '1.651 м2' },
    inStock: true
  },
  {
    id: 'box-2631',
    name: 'Gofrbox 600x400x285 (2631)',
    name_ru: 'Гофроящик 600x400x285 (2631)',
    category: 'Boxes',
    subcategory: '4-flap',
    ...
    price: 72.00,
    specs: { 'Dimensions': '600x400x285mm', 'Code': '2631', 'Volume': '68.4L', 'Area': '1.416 m2' },
    specs_ru: { 'Размеры': '600x400x285мм', 'Артикул': '2631', 'Объем': '68.4л', 'Площадь': '1.416 м2' },
    inStock: true
  },
  {
    id: 'box-4604',
    name: 'Gofrbox 600x300x230 (4604)',
    name_ru: 'Гофроящик 600x300x230 (4604)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    ...
    price: 45.00,
    specs: { 'Dimensions': '600x300x230mm', 'Code': '4604', 'Volume': '41.4L', 'Area': '0.991 m2' },
    specs_ru: { 'Размеры': '600x300x230мм', 'Артикул': '4604', 'Объем': '41.4л', 'Площадь': '0.991 м2' },
    inStock: true
  },
  {
    id: 'box-28',
    name: 'Gofrbox 570x285x190 (28)',
    name_ru: 'Гофроящик 570x285x190 (28)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    ...
    price: 43.00,
    specs: { 'Dimensions': '570x285x190mm', 'Code': '28', 'Volume': '30.9L', 'Area': '0.846 m2' },
    specs_ru: { 'Размеры': '570x285x190мм', 'Артикул': '28', 'Объем': '30.9л', 'Площадь': '0.846 м2' },
    inStock: true
  },
  {
    id: 'box-996',
    name: 'Gofrbox 565x404x494 (996)',
    name_ru: 'Гофроящик 565x404x494 (996)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1598524374912-6b0fae3f0363?auto=format&fit=crop&w=800&q=80',
    ...
    price: 92.00,
    specs: { 'Dimensions': '565x404x494mm', 'Code': '996', 'Volume': '112.8L', 'Area': '1.796 m2' },
    specs_ru: { 'Размеры': '565x404x494мм', 'Артикул': '996', 'Объем': '112.8л', 'Площадь': '1.796 м2' },
    inStock: true
  },
  {
    id: 'box-b76',
    name: 'Gofrbox 450x350x250 (B-76)',
    name_ru: 'Гофроящик 450x350x250 (Б-76)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    ...
    price: 51.00,
    specs: { 'Dimensions': '450x350x250mm', 'Code': 'B-76', 'Volume': '39.4L', 'Area': '0.999 m2' },
    specs_ru: { 'Размеры': '450x350x250мм', 'Артикул': 'Б-76', 'Объем': '39.4л', 'Площадь': '0.999 м2' },
    inStock: true
  },
  {
    id: 'box-52',
    name: 'Gofrbox 412x310x165 (52)',
    name_ru: 'Гофроящик 412x310x165 (52)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    ...
    price: 36.50,
    specs: { 'Dimensions': '412x310x165mm', 'Code': '52', 'Volume': '21.1L', 'Area': '0.718 m2' },
    specs_ru: { 'Размеры': '412x310x165мм', 'Артикул': '52', 'Объем': '21.1л', 'Площадь': '0.718 м2' },
    inStock: true
  },
  {
    id: 'box-400',
    name: 'Gofrbox 400x400x300',
    name_ru: 'Гофроящик 400x400x300',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1598524374912-6b0fae3f0363?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 36L.',
    description_ru: 'Объем: 36л.',
    price: 45.00,
    specs: { 'Dimensions': '400x400x300mm', 'Volume': '36L' },
    specs_ru: { 'Размеры': '400x400x300мм', 'Объем': '36л' },
    inStock: true
  },
  {
    id: 'box-722',
    name: 'Gofrbox 390x330x290 (722)',
    name_ru: 'Гофроящик 390x330x290 (722)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    ...
    price: 47.50,
    specs: { 'Dimensions': '390x330x290mm', 'Code': '722', 'Volume': '37.3L', 'Area': '0.932 m2' },
    specs_ru: { 'Размеры': '390x330x290мм', 'Артикул': '722', 'Объем': '37.3л', 'Площадь': '0.932 м2' },
    inStock: true
  },
  {
    id: 'box-38',
    name: 'Gofrbox 380x304x285 (38)',
    name_ru: 'Гофроящик 380x304x285 (38)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    ...
    price: 43.00,
    specs: { 'Dimensions': '380x304x285mm', 'Code': '38', 'Volume': '32.9L', 'Area': '0.843 m2' },
    specs_ru: { 'Размеры': '380x304x285мм', 'Артикул': '38', 'Объем': '32.9л', 'Площадь': '0.843 м2' },
    inStock: true
  },
  {
    id: 'box-17',
    name: 'Gofrbox 380x285x228 (17)',
    name_ru: 'Гофроящик 380x285x228 (17)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    ...
    price: 36.00,
    specs: { 'Dimensions': '380x285x228mm', 'Code': '17', 'Volume': '24.7L', 'Area': '0.716 m2' },
    specs_ru: { 'Размеры': '380x285x228мм', 'Артикул': '17', 'Объем': '24.7л', 'Площадь': '0.716 м2' },
    inStock: true
  },
  {
    id: 'box-7',
    name: 'Gofrbox 380x253x237 (7)',
    name_ru: 'Гофроящик 380x253x237 (7)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    ...
    price: 33.00,
    specs: { 'Dimensions': '380x253x237mm', 'Code': '7', 'Volume': '22.8L', 'Area': '0.652 m2' },
    specs_ru: { 'Размеры': '380x253x237мм', 'Артикул': '7', 'Объем': '22.8л', 'Площадь': '0.652 м2' },
    inStock: true
  },
  {
    id: 'box-12',
    name: 'Gofrbox 380x285x95 (12)',
    name_ru: 'Гофроящик 380x285x95 (12)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    ...
    price: 27.00,
    specs: { 'Dimensions': '380x285x95mm', 'Code': '12', 'Volume': '21.1L', 'Area': '0.532 m2' },
    specs_ru: { 'Размеры': '380x285x95мм', 'Артикул': '12', 'Объем': '21.1л', 'Площадь': '0.532 м2' },
    inStock: true
  },
  {
    id: 'box-36-1',
    name: 'Gofrbox 380x300x180 (36-1)',
    name_ru: 'Гофроящик 380x300x180 (36-1)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    ...
    price: 35.00,
    specs: { 'Dimensions': '380x300x180mm', 'Code': '36-1', 'Volume': '20.5L', 'Area': '0.685 m2' },
    specs_ru: { 'Размеры': '380x300x180мм', 'Артикул': '36-1', 'Объем': '20.5л', 'Площадь': '0.685 м2' },
    inStock: true
  },
  {
    id: 'box-14',
    name: 'Gofrbox 380x285x142 (14)',
    name_ru: 'Гофроящик 380x285x142 (14)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    ...
    price: 30.50,
    specs: { 'Dimensions': '380x285x142mm', 'Code': '14', 'Volume': '15.4L', 'Area': '0.597 m2' },
    specs_ru: { 'Размеры': '380x285x142мм', 'Артикул': '14', 'Объем': '15.4л', 'Площадь': '0.597 м2' },
    inStock: true
  },
  {
    id: 'box-282',
    name: 'Gofrbox 380x253x120 (282)',
    name_ru: 'Гофроящик 380x253x120 (282)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    ...
    price: 25.00,
    specs: { 'Dimensions': '380x253x120mm', 'Code': '282', 'Volume': '11.5L', 'Area': '0.498 m2' },
    specs_ru: { 'Размеры': '380x253x120мм', 'Артикул': '282', 'Объем': '11.5л', 'Площадь': '0.498 м2' },
    inStock: true
  },
  {
    id: 'box-4273',
    name: 'Gofrbox 350x350x350 (4273)',
    name_ru: 'Гофроящик 350x350x350 (4273)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1598524374912-6b0fae3f0363?auto=format&fit=crop&w=800&q=80',
    description: 'Cubic box. Volume: 42.9L. Area: 1.037 m2.',
    description_ru: 'Кубический ящик. Объем: 42.9л. Площадь: 1.037 м2.',
    price: 38.00,
    specs: { 'Dimensions': '350x350x350mm', 'Code': '4273', 'Volume': '42.9L', 'Area': '1.037 m2' },
    specs_ru: { 'Размеры': '350x350x350мм', 'Артикул': '4273', 'Объем': '42.9л', 'Площадь': '1.037 м2' },
    inStock: true
  },
  {
    id: 'box-1614',
    name: 'Gofrbox 345x245x260 (1614)',
    name_ru: 'Гофроящик 345x245x260 (1614)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1606170849160-537999974954?auto=format&fit=crop&w=800&q=80',
    description: 'Archival Box. Volume: 22L. Area: 0.628 m2.',
    description_ru: 'Архивный ящик. Объем: 22л. Площадь: 0.628 м2.',
    price: 35.00,
    specs: { 'Dimensions': '345x245x260mm', 'Code': '1614', 'Volume': '22L', 'Area': '0.628 m2' },
    specs_ru: { 'Размеры': '345x245x260мм', 'Артикул': '1614', 'Объем': '22л', 'Площадь': '0.628 м2' },
    inStock: true
  },
  {
    id: 'box-717',
    name: 'Gofrbox 310x210x170 (717)',
    name_ru: 'Гофроящик 310x210x170 (717)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 11.1L. Area: 0.42 m2.',
    description_ru: 'Объем: 11.1л. Площадь: 0.42 м2.',
    price: 21.50,
    specs: { 'Dimensions': '310x210x170mm', 'Code': '717', 'Volume': '11.1L', 'Area': '0.42 m2' },
    specs_ru: { 'Размеры': '310x210x170мм', 'Артикул': '717', 'Объем': '11.1л', 'Площадь': '0.42 м2' },
    inStock: true
  },
  {
    id: 'box-1446',
    name: 'Gofrbox 270x220x100 (1446)',
    name_ru: 'Гофроящик 270x220x100 (1446)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1589822466118-686113c34fb3?auto=format&fit=crop&w=800&q=80',
    ...
    price: 17.00,
    specs: { 'Dimensions': '270x220x100mm', 'Code': '1446', 'Volume': '5.9L', 'Area': '0.335 m2' },
    specs_ru: { 'Размеры': '270x220x100мм', 'Артикул': '1446', 'Объем': '5.9л', 'Площадь': '0.335 м2' },
    inStock: true
  },
  {
    id: 'box-917',
    name: 'Gofrbox 200x185x130 (917)',
    name_ru: 'Гофроящик 200x185x130 (917)',
    category: 'Boxes',
    subcategory: '4-flap',
    ...
    price: 13.00,
    specs: { 'Dimensions': '200x185x130mm', 'Code': '917', 'Volume': '4.8L', 'Area': '0.263 m2' },
    specs_ru: { 'Размеры': '200x185x130мм', 'Артикул': '917', 'Объем': '4.8л', 'Площадь': '0.263 м2' },
    inStock: true
  },
  {
    id: 'box-1826',
    name: 'Gofrbox 200x120x120 (1826)',
    name_ru: 'Гофроящик 200x120x120 (1826)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    ...
    price: 10.00,
    specs: { 'Dimensions': '200x120x120mm', 'Code': '1826', 'Volume': '2.9L', 'Area': '0.169 m2' },
    specs_ru: { 'Размеры': '200x120x120мм', 'Артикул': '1826', 'Объем': '2.9л', 'Площадь': '0.169 м2' },
    inStock: true
  },
  {
    id: 'box-4578',
    name: 'Gofrbox 180x120x100 (4578)',
    name_ru: 'Гофроящик 180x120x100 (4578)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    ...
    price: 15.00,
    specs: { 'Dimensions': '180x120x100mm', 'Code': '4578', 'Volume': '2.2L' },
    specs_ru: { 'Размеры': '180x120x100мм', 'Артикул': '4578', 'Объем': '2.2л' },
    inStock: true
  },
  {
    id: 'box-498',
    name: 'Gofrbox 150x150x100 (498)',
    name_ru: 'Гофроящик 150x150x100 (498)',
    category: 'Boxes',
    subcategory: '4-flap',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    ...
    price: 8.30,
    specs: { 'Dimensions': '150x150x100mm', 'Code': '498', 'Volume': '2.3L', 'Area': '0.166 m2' },
    specs_ru: { 'Размеры': '150x150x100мм', 'Артикул': '498', 'Объем': '2.3л', 'Площадь': '0.166 м2' },
    inStock: true
  },

  // Self-Assembling and Complex
  {
    id: 'box-sa-3711',
    name: 'Self-Assembling Box 227x187x84 (CDEK 3711/1)',
    name_ru: 'Коробка самосборная 227x187x84 (СДЭК 3711/1)',
    category: 'Boxes',
    subcategory: 'self-assembling',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 3.6L. Area: 0.164 m2.',
    description_ru: 'Объем: 3.6л. Площадь: 0.164 м2.',
    price: 23.10,
    specs: { 'Dimensions': '227x187x84mm', 'Code': '3711/1', 'Volume': '3.6L', 'Area': '0.164 m2' },
    specs_ru: { 'Размеры': '227x187x84мм', 'Артикул': '3711/1', 'Объем': '3.6л', 'Площадь': '0.164 м2' },
    inStock: true
  },
  {
    id: 'box-sa-3976',
    name: 'Self-Assembling Box 166x116x72 (CDEK 3976/1)',
    name_ru: 'Коробка самосборная 166x116x72 (СДЭК 3976/1)',
    category: 'Boxes',
    subcategory: 'self-assembling',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 1.4L. Area: 0.119 m2.',
    description_ru: 'Объем: 1.4л. Площадь: 0.119 м2.',
    price: 12.70,
    specs: { 'Dimensions': '166x116x72mm', 'Code': '3976/1', 'Volume': '1.4L', 'Area': '0.119 m2' },
    specs_ru: { 'Размеры': '166x116x72мм', 'Артикул': '3976/1', 'Объем': '1.4л', 'Площадь': '0.119 м2' },
    inStock: true
  },
  {
    id: 'box-sa-c47',
    name: 'Self-Assembling Box 215x110x92 (C-47)',
    name_ru: 'Коробка самосборная 215x110x92 (C-47)',
    category: 'Boxes',
    subcategory: 'self-assembling',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 2.2L.',
    description_ru: 'Объем: 2.2л.',
    price: 13.00,
    specs: { 'Dimensions': '215x110x92mm', 'Code': 'C-47', 'Volume': '2.2L' },
    specs_ru: { 'Размеры': '215x110x92мм', 'Артикул': 'C-47', 'Объем': '2.2л' },
    inStock: true
  },
  {
    id: 'box-sa-c45',
    name: 'Self-Assembling Box 235x103x60 (C-45)',
    name_ru: 'Коробка самосборная 235x103x60 (C-45)',
    category: 'Boxes',
    subcategory: 'self-assembling',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 1.5L. Area: 0.123 m2.',
    description_ru: 'Объем: 1.5л. Площадь: 0.123 м2.',
    price: 13.00,
    specs: { 'Dimensions': '235x103x60mm', 'Code': 'C-45', 'Volume': '1.5L', 'Area': '0.123 m2' },
    specs_ru: { 'Размеры': '235x103x60мм', 'Артикул': 'C-45', 'Объем': '1.5л', 'Площадь': '0.123 м2' },
    inStock: true
  },
  {
    id: 'box-sa-4751',
    name: 'Self-Assembling Box 170x90x90 (4751)',
    name_ru: 'Коробка самосборная 170x90x90 (4751)',
    category: 'Boxes',
    subcategory: 'self-assembling',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 1.4L.',
    description_ru: 'Объем: 1.4л.',
    price: 16.00,
    specs: { 'Dimensions': '170x90x90mm', 'Code': '4751', 'Volume': '1.4L' },
    specs_ru: { 'Размеры': '170x90x90мм', 'Артикул': '4751', 'Объем': '1.4л' },
    inStock: true
  },
  {
    id: 'box-sa-mini',
    ...
    subcategory: 'self-assembling',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 1L. Area: 0.136 m2.',
    description_ru: 'Объем: 1л. Площадь: 0.136 м2.',
    price: undefined,
    specs: { 'Dimensions': '100x100x100mm', 'Code': 'Mini', 'Volume': '1L', 'Area': '0.136 m2' },
    specs_ru: { 'Размеры': '100x100x100мм', 'Артикул': 'Мини', 'Объем': '1л', 'Площадь': '0.136 м2' },
    inStock: true
  },
  {
    id: 'box-sa-45mg',
    name: 'Self-Assembling Box 170x80x65 (45mg)',
    name_ru: 'Коробка самосборная 170x80x65 (45мг)',
    category: 'Boxes',
    subcategory: 'self-assembling',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 0.9L. Area: 0.083 m2.',
    description_ru: 'Объем: 0.9л. Площадь: 0.083 м2.',
    price: 11.60,
    specs: { 'Dimensions': '170x80x65mm', 'Code': '45mg', 'Volume': '0.9L', 'Area': '0.083 m2' },
    specs_ru: { 'Размеры': '170x80x65мм', 'Артикул': '45мг', 'Объем': '0.9л', 'Площадь': '0.083 м2' },
    inStock: true
  },
  {
    id: 'box-sa-263',
    name: 'Self-Assembling Box 260x100x30 (263)',
    name_ru: 'Коробка самосборная 260x100x30 (263)',
    category: 'Boxes',
    subcategory: 'self-assembling',
    imageUrl: 'https://images.unsplash.com/photo-1566635285666-30a4e569eb9b?auto=format&fit=crop&w=800&q=80',
    description: 'Volume: 0.8L. Area: 0.105 m2.',
    description_ru: 'Объем: 0.8л. Площадь: 0.105 м2.',
    price: 13.30,
    specs: { 'Dimensions': '260x100x30mm', 'Code': '263', 'Volume': '0.8L', 'Area': '0.105 m2' },
    specs_ru: { 'Размеры': '260x100x30мм', 'Артикул': '263', 'Объем': '0.8л', 'Площадь': '0.105 м2' },
    inStock: true
  },
  ...
  // Sheets, Rolls, Pads
  {
    ...
    description: 'Large format sheet. Area: 3.4 m2.',
    description_ru: 'Лист большого формата. Площадь: 3.4 м2.',
    price: 157.00,
    specs: { 'Dimensions': '2500x1360mm', 'Area': '3.4 m2' },
    specs_ru: { 'Размеры': '2500x1360мм', 'Площадь': '3.4 м2' },
    inStock: true
  },
  {
    id: 'pad-1200',
    ...
    subcategory: 'sheets',
    imageUrl: 'https://images.unsplash.com/photo-1617788735124-6627609b054c?auto=format&fit=crop&w=800&q=80',
    description: 'Area: 0.96 m2.',
    description_ru: 'Площадь: 0.96 м2.',
    price: 42.00,
    specs: { 'Dimensions': '1200x800mm', 'Area': '0.96 m2' },
    specs_ru: { 'Размеры': '1200x800мм', 'Площадь': '0.96 м2' },
    inStock: true
  },
  {
    id: 'pad-600',
    ...
    subcategory: 'sheets',
    imageUrl: 'https://images.unsplash.com/photo-1617788735124-6627609b054c?auto=format&fit=crop&w=800&q=80',
    description: 'Area: 0.24 m2.',
    description_ru: 'Площадь: 0.24 м2.',
    price: 10.00,
    specs: { 'Dimensions': '600x400mm', 'Area': '0.24 m2' },
    specs_ru: { 'Размеры': '600x400мм', 'Площадь': '0.24 м2' },
    inStock: true
  },
  {
    id: 'pad-375',
    name: 'Pad 375x248',
    name_ru: 'Прокладка 375x248',
    category: 'Boxes',
    subcategory: 'sheets',
    imageUrl: 'https://images.unsplash.com/photo-1617788735124-6627609b054c?auto=format&fit=crop&w=800&q=80',
    description: 'Area: 0.093 m2.',
    description_ru: 'Площадь: 0.093 м2.',
    price: 4.00,
    specs: { 'Dimensions': '375x248mm', 'Area': '0.093 m2' },
    specs_ru: { 'Размеры': '375x248мм', 'Площадь': '0.093 м2' },
    inStock: true
  },
  {
    id: 'pad-395',
    name: 'Pad 395x190 (P302)',
    name_ru: 'Прокладка 395x190 (П302)',
    category: 'Boxes',
    subcategory: 'sheets',
    imageUrl: 'https://images.unsplash.com/photo-1617788735124-6627609b054c?auto=format&fit=crop&w=800&q=80',
    description: 'Protective pad.',
    description_ru: 'Защитная прокладка.',
    price: 3.00,
    specs: { 'Dimensions': '395x190mm', 'Code': 'P302' },
    specs_ru: { 'Размеры': '395x190мм', 'Артикул': 'П302' },
    inStock: true
  },
  {
    id: 'pad-510',
    ...
    description_ru: 'Защитная прокладка.',
    price: 3.00,
    specs: { 'Dimensions': '510x170mm' },
    specs_ru: { 'Размеры': '510x170мм' },
    inStock: true
  },
  {
    id: 'roll-1050',
    ...
    description: '2-layer corrugated roll. Area: 52.5 m2.',
    description_ru: '2-х слойный гофрокартон. Площадь: 52.5 м2.',
    price: 2200.00,
    specs: { 'Dimensions': '1050mm x 50m', 'Type': 'Roll', 'Layers': '2', 'Area': '52.5 m2' },
    specs_ru: { 'Размеры': '1050мм х 50м', 'Тип': 'Рулон', 'Слои': '2', 'Площадь': '52.5 м2' },
    inStock: true
  },
  ...
  {
    id: 'tray-143',
    name: 'Tray 565x377x111 (143)',
    name_ru: 'Гофролоток 565x377x111 (143)',
    category: 'Boxes',
    subcategory: 'food',
    imageUrl: 'https://images.unsplash.com/photo-1605049299140-5909d14dbf3a?auto=format&fit=crop&w=800&q=80',
    description: 'Poultry meat tray.',
    description_ru: 'Лоток под мясо кур.',
    price: 43.00,
    specs: { 'Dimensions': '565x377x111mm', 'Code': '143', 'Usage': 'Poultry' },
    specs_ru: { 'Размеры': '565x377x111мм', 'Артикул': '143', 'Назначение': 'Мясо кур' },
    inStock: true
  },
  {
    id: 'tray-219',
    name: 'Tray 560x390x180 (219)',
    name_ru: 'Гофролоток 560x390x180 (219)',
    category: 'Boxes',
    subcategory: 'food',
    imageUrl: 'https://images.unsplash.com/photo-1605049299140-5909d14dbf3a?auto=format&fit=crop&w=800&q=80',
    description: 'Eggplant tray.',
    description_ru: 'Лоток под баклажаны.',
    price: undefined,
    specs: { 'Dimensions': '560x390x180mm', 'Code': '219', 'Usage': 'Eggplant' },
    specs_ru: { 'Размеры': '560x390x180мм', 'Артикул': '219', 'Назначение': 'Баклажаны' },
    inStock: true
  },
  {
    id: 'tray-217',
    name: 'Tray 360x290x170 (217)',
    name_ru: 'Гофролоток 360x290x170 (217)',
    category: 'Boxes',
    subcategory: 'food',
    imageUrl: 'https://images.unsplash.com/photo-1605049299140-5909d14dbf3a?auto=format&fit=crop&w=800&q=80',
    description: 'Vegetable tray (Tomatoes, Cucumbers).',
    description_ru: 'Лоток овощной (Помидоры, огурцы).',
    price: 36.00,
    specs: { 'Dimensions': '360x290x170mm', 'Code': '217', 'Usage': 'Vegetables' },
    specs_ru: { 'Размеры': '360x290x170мм', 'Артикул': '217', 'Назначение': 'Овощи' },
    inStock: true
  },
  {
    id: 'tray-848',
    name: 'Tray 380x280x105 (848)',
    name_ru: 'Гофролоток 380x280x105 (848)',
    category: 'Boxes',
    subcategory: 'food',
    imageUrl: 'https://images.unsplash.com/photo-1605049299140-5909d14dbf3a?auto=format&fit=crop&w=800&q=80',
    description: 'Confectionery tray, white.',
    description_ru: 'Лоток кондитерский, белый.',
    price: 23.00,
    specs: { 'Dimensions': '380x280x105mm', 'Code': '848', 'Usage': 'Confectionery', 'Color': 'White' },
    specs_ru: { 'Размеры': '380x280x105мм', 'Артикул': '848', 'Назначение': 'Кондитерский', 'Цвет': 'Белый' },
    inStock: true
  },
  {
    id: 'tray-c86',
    name: 'Tray 380x280x60 (C-86)',
    name_ru: 'Гофролоток 380x280x60 (C-86)',
    category: 'Boxes',
    subcategory: 'food',
    imageUrl: 'https://images.unsplash.com/photo-1605049299140-5909d14dbf3a?auto=format&fit=crop&w=800&q=80',
    description: 'Confectionery tray, white.',
    description_ru: 'Лоток кондитерский, белый.',
    price: 21.00,
    specs: { 'Dimensions': '380x280x60mm', 'Code': 'C-86', 'Usage': 'Confectionery', 'Color': 'White' },
    specs_ru: { 'Размеры': '380x280x60мм', 'Артикул': 'C-86', 'Назначение': 'Кондитерский', 'Цвет': 'Белый' },
    inStock: true
  },
  {
    id: 'tray-38m',
    name: 'Tray 258x208x63 (38m)',
    name_ru: 'Гофролоток 258x208x63 (38м)',
    category: 'Boxes',
    subcategory: 'food',
    imageUrl: 'https://images.unsplash.com/photo-1605049299140-5909d14dbf3a?auto=format&fit=crop&w=800&q=80',
    description: 'Confectionery tray.',
    description_ru: 'Лоток кондитерский.',
    price: undefined,
    specs: { 'Dimensions': '258x208x63mm', 'Code': '38m', 'Usage': 'Confectionery' },
    specs_ru: { 'Размеры': '258x208x63мм', 'Артикул': '38м', 'Назначение': 'Кондитерский' },
    inStock: true
  },
  {
    id: 'tray-46m',
    name: 'Tray 258x208x48 (46m)',
    ...
    description_ru: 'Лоток кондитерский.',
    price: undefined,
    specs: { 'Dimensions': '258x208x48mm', 'Code': '46m', 'Usage': 'Confectionery' },
    specs_ru: { 'Размеры': '258x208x48мм', 'Артикул': '46м', 'Назначение': 'Кондитерский' },
    inStock: true
  },
  {
    id: 'box-pizza-1344',
    name: 'Pizza Box 373x366x45 (1344/2)',
    name_ru: 'Ящик для пиццы 373x366x45 (1344/2)',
    category: 'Boxes',
    subcategory: 'food',
    imageUrl: 'https://images.unsplash.com/photo-1595246140625-573b715e56d8?auto=format&fit=crop&w=800&q=80',
    description: 'Pizza box, brown.',
    description_ru: 'Ящик для пиццы, бурый.',
    price: undefined,
    specs: { 'Dimensions': '373x366x45mm', 'Code': '1344/2', 'Usage': 'Pizza', 'Color': 'Brown' },
    specs_ru: { 'Размеры': '373x366x45мм', 'Артикул': '1344/2', 'Назначение': 'Пицца', 'Цвет': 'Бурый' },
    inStock: true
  },
